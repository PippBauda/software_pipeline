# Software Development Pipeline Formal Model — v4.0
...
**Field descriptions**:
- `schema_version`: manifest schema version (`4.0`), verified by B1 for compatibility
...
*End of formal pipeline model v4.0.*
